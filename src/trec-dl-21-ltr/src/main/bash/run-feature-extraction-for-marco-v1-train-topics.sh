...
java -jar target/trec-dl-21-ltr-1.0-SNAPSHOT-jar-with-dependencies.jar \
	...
	--runFile /mnt/ceph/storage/data-in-progress/data-research/web-search/TREC-21/resources-trec-dl-20/msmarco-doctrain-top100.gz | tee feature-extraction-marco-v1-train.log
